...
*/}}
{{- define "splunk-k8s-win-logging.name" -}}
...
*/}}
{{- define "splunk-k8s-win-logging.fullname" -}}
...
*/}}
{{- define "splunk-k8s-win-logging.chart" -}}
...
Create chart name and version as used by the chart label.
*/}}
{{- define "splunk-k8s-win-logging.secret" -}}
...
*/}}
{{- define "splunk-k8s-win-logging.convert-memory" -}}
{{- $mem := lower . -}}
{{- if hasSuffix "p" $mem -}}
...
*/}}
{{- define "splunk-k8s-win-logging.container_jq_filter" -}}
{{- $logs := dict "list" list }}
...
{{- define "splunk-k8s-win-logging.set_sourcetype" -}}
{{- $logs := dict "list" list }}
{{- range $name, $logDef := .Values.logs }}
{{- if (and $logDef.from.pod $logDef.sourcetype) }}
{{- set $logs "list" (append $logs.list (dict "name" $name "from" $logDef.from "sourcetype" $logDef.sourcetype)) | and nil }}
...
*/}}
{{- define "splunk-k8s-win-logging.serviceAccountName" -}}
    {{ default (include "splunk-k8s-win-logging.fullname" .) .Values.serviceAccount.name }}
{{- end -}}
Create the image name
*/}}
{{- define "splunk-k8s-win-logging.image" -}}
